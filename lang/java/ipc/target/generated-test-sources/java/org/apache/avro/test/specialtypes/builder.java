...
public class builder extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9060005353659243954L;
  ...
  public static builder fromByteBuffer(
   ...
   private org.apache.avro.test.specialtypes.Two builder;
   ...
   */
  public builder(org.apache.avro.test.specialtypes.One this$, org.apache.avro.test.specialtypes.Two builder) {
    this.this$ = this$;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: builder = (org.apache.avro.test.specialtypes.Two)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public org.apache.avro.test.specialtypes.Two getBuilder() {
    return builder;
  }

  /**
   * Gets the value of the 'builder' field as an Optional&lt;org.apache.avro.test.specialtypes.Two&gt;.
   * @return The value wrapped in an Optional&lt;org.apache.avro.test.specialtypes.Two&gt;.
   */
  public Optional<org.apache.avro.test.specialtypes.Two> getOptionalBuilder() {
    return Optional.<org.apache.avro.test.specialtypes.Two>ofNullable(builder);
  }
   ...
   * @param value the value to set.
   */
  public void setBuilder(org.apache.avro.test.specialtypes.Two value) {
    this.builder = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<builder>
    ...
    private org.apache.avro.test.specialtypes.Two builder;
    private org.apache.avro.test.specialtypes.Two.Builder builderBuilder;
    ...
    private Builder(org.apache.avro.test.specialtypes.builder.Builder other) {
      ...
      if (other.hasBuilderBuilder()) {
        this.builderBuilder = org.apache.avro.test.specialtypes.Two.newBuilder(other.getBuilderBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.test.specialtypes.builder.Builder setBuilder(org.apache.avro.test.specialtypes.Two value) {
    ...
    /**
     * Gets the Builder instance for the 'builder' field and creates one if it doesn't exist yet.
     * @return This builder.
     */
    public org.apache.avro.test.specialtypes.Two.Builder getBuilderBuilder() {
      if (builderBuilder == null) {
        if (hasBuilder()) {
          setBuilderBuilder(org.apache.avro.test.specialtypes.Two.newBuilder(builder));
        } else {
          setBuilderBuilder(org.apache.avro.test.specialtypes.Two.newBuilder());
        }
      }
    ...
    /**
     * Sets the Builder instance for the 'builder' field
     * @param value The builder instance that must be set.
     * @return This builder.
     */
    public org.apache.avro.test.specialtypes.builder.Builder setBuilderBuilder(org.apache.avro.test.specialtypes.Two.Builder value) {
      clearBuilder();
      builderBuilder = value;
      return this;
    }

    /**
     * Checks whether the 'builder' field has an active Builder instance
     * @return True if the 'builder' field has an active Builder instance
     */
    public boolean hasBuilderBuilder() {
      return builderBuilder != null;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.test.specialtypes.builder.Builder clearBuilder() {
      builder = null;
      builderBuilder = null;
    ...
    public builder build() {
      try {
        ...
        if (builderBuilder != null) {
          try {
            record.builder = this.builderBuilder.build();
          } catch (org.apache.avro.AvroMissingFieldException e) {
            e.addParentField(record.getSchema().getField("builder"));
            throw e;
          }
        } else {
          record.builder = fieldSetFlags()[1] ? this.builder : (org.apache.avro.test.specialtypes.Two) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.builder == null) {
        this.builder = new org.apache.avro.test.specialtypes.Two();
      }
      this.builder.customDecode(in);

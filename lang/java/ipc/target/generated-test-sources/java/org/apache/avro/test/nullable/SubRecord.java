...
public class SubRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7710298177673560475L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SubRecord\",\"namespace\":\"org.apache.avro.test.nullable\",\"fields\":[{\"name\":\"value\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public SubRecord(java.lang.String value) {
    this.value = value;
  }
   ...
   */
  public static org.apache.avro.test.nullable.SubRecord.Builder newBuilder() {
    return new org.apache.avro.test.nullable.SubRecord.Builder();
  }
   ...
   * @return A new SubRecord RecordBuilder
   */
  public static org.apache.avro.test.nullable.SubRecord.Builder newBuilder(org.apache.avro.test.nullable.SubRecord.Builder other) {
    if (other == null) {
      return new org.apache.avro.test.nullable.SubRecord.Builder();
    } else {
      return new org.apache.avro.test.nullable.SubRecord.Builder(other);
    }
  }
   ...
   * @return A new SubRecord RecordBuilder
   */
  public static org.apache.avro.test.nullable.SubRecord.Builder newBuilder(org.apache.avro.test.nullable.SubRecord other) {
    if (other == null) {
      return new org.apache.avro.test.nullable.SubRecord.Builder();
    } else {
      return new org.apache.avro.test.nullable.SubRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SubRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.apache.avro.test.nullable.SubRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.apache.avro.test.nullable.SubRecord other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.test.nullable.SubRecord.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.test.nullable.SubRecord.Builder clearValue() {
      value = null;

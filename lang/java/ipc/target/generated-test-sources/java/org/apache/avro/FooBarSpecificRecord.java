...
public class FooBarSpecificRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<FooBarSpecificRecord> getEncoder() {
    return ENCODER;
  }
  ...
  /**
   * Gets the value of the 'id' field as an Optional&lt;java.lang.Integer&gt;.
   * @return The value wrapped in an Optional&lt;java.lang.Integer&gt;.
   */
  public Optional<java.lang.Integer> getOptionalId() {
  ...
  /**
   * Gets the value of the 'nicknames' field as an Optional&lt;java.util.List<java.lang.String>&gt;.
   * @return The value wrapped in an Optional&lt;java.util.List<java.lang.String>&gt;.
   */
  public Optional<java.util.List<java.lang.String>> getOptionalNicknames() {
  ...
  /**
   * Gets the value of the 'relatedids' field as an Optional&lt;java.util.List<java.lang.Integer>&gt;.
   * @return The value wrapped in an Optional&lt;java.util.List<java.lang.Integer>&gt;.
   */
  public Optional<java.util.List<java.lang.Integer>> getOptionalRelatedids() {
  ...
  /**
   * Gets the value of the 'typeEnum' field as an Optional&lt;org.apache.avro.TypeEnum&gt;.
   * @return The value wrapped in an Optional&lt;org.apache.avro.TypeEnum&gt;.
   */
  public Optional<org.apache.avro.TypeEnum> getOptionalTypeEnum() {
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (java.lang.String e0: this.nicknames) {
      actualSize0++;
      out.startItem();
      out.writeString(e0);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<java.lang.String> a0 = this.nicknames;
      if (a0 == null) {
        a0 = new SpecificData.Array<java.lang.String>((int)size0, SCHEMA$.getField("nicknames").schema());
        this.nicknames = a0;
      } else a0.clear();
      ...
      if (a1 == null) {
        a1 = new SpecificData.Array<java.lang.Integer>((int)size1, SCHEMA$.getField("relatedids").schema());
        this.relatedids = a1;
      } else a1.clear();

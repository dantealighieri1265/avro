...
public class Weather extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7109409236380254773L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Weather\",\"namespace\":\"test\",\"doc\":\"A weather reading.\",\"fields\":[{\"name\":\"station\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"order\":\"ignore\"},{\"name\":\"time\",\"type\":\"long\"},{\"name\":\"temp\",\"type\":\"int\"}]}");
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: station = value$ != null ? value$.toString() : null; break;
  ...
  /**
   * Gets the value of the 'station' field as an Optional&lt;java.lang.String&gt;.
   * @return The value wrapped in an Optional&lt;java.lang.String&gt;.
   */
  public Optional<java.lang.String> getOptionalStation() {
    return Optional.<java.lang.String>ofNullable(station);
  }
  ...
  /**
   * Gets the value of the 'time' field as an Optional&lt;java.lang.Long&gt;.
   * @return The value wrapped in an Optional&lt;java.lang.Long&gt;.
   */
  public Optional<java.lang.Long> getOptionalTime() {
    return Optional.<java.lang.Long>ofNullable(time);
  }
  ...
  /**
   * Gets the value of the 'temp' field as an Optional&lt;java.lang.Integer&gt;.
   * @return The value wrapped in an Optional&lt;java.lang.Integer&gt;.
   */
  public Optional<java.lang.Integer> getOptionalTemp() {
    return Optional.<java.lang.Integer>ofNullable(temp);
  }
   ...
   */
  public static test.Weather.Builder newBuilder() {
    return new test.Weather.Builder();
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static test.Weather.Builder newBuilder(test.Weather.Builder other) {
    if (other == null) {
      return new test.Weather.Builder();
    } else {
      return new test.Weather.Builder(other);
    }
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static test.Weather.Builder newBuilder(test.Weather other) {
    if (other == null) {
      return new test.Weather.Builder();
    } else {
      return new test.Weather.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Weather>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(test.Weather.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(test.Weather other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.station)) {
        this.station = data().deepCopy(fields()[0].schema(), other.station);
    ...
    /**
      ...
      * @return This builder.
      */
    public test.Weather.Builder setStation(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public test.Weather.Builder clearStation() {
      station = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public test.Weather.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public test.Weather.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public test.Weather.Builder setTemp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public test.Weather.Builder clearTemp() {

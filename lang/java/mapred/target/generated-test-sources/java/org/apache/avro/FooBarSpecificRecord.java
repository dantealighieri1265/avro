...
public class FooBarSpecificRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public FooBarSpecificRecord(java.lang.Integer id, java.lang.CharSequence name, java.util.List<java.lang.CharSequence> nicknames, java.util.List<java.lang.Integer> relatedids, org.apache.avro.TypeEnum typeEnum) {
    this.id = id;
    this.name = name;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FooBarSpecificRecord>
    ...
    public FooBarSpecificRecord build() {
      try {
        ...
        record.nicknames = fieldSetFlags()[2] ? this.nicknames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<java.lang.CharSequence>((int)size0, SCHEMA$.getField("nicknames").schema());
        this.nicknames = a0;
      } else a0.clear();
